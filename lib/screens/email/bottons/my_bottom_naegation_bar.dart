      ...
      onPressed: () async {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            ...
            content:
                Text('Se ha enviado un correo e lectrónico de confirmación', ),
          ),
        );
      },
...
flexibleSpace:  Row(
  ...
  children: [UserProfileAvatar(avatarUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSumsFnCbTdA2Nbo2tKJxbowPN70kWltlRtyJOXhmCV&s', onAvatarTap:(){if (kDebugMode) {
    print('Avatar Tapped...');
  }
...
children: <Widget> [  
    IconButton(onPressed: () {  setState(() {
      showIndications = !showIndications;
        ...
        icon:
        const Icon(Icons.info_outline,textDirection: TextDirection.ltr ,color: Color.fromARGB(216, 107, 45, 1170),),
    tooltip: 'Presione el boton para ver las inicaiones'),
    
    if(showIndications )   const
    Text( '- Al Momento de darle click te envian un  correo a tu nuevo correo',
...
cursorColor: const Color.fromARGB(216, 107, 45, 1170),
  decoration:  InputDecoration(
   ...
   focusedBorder:const OutlineInputBorder(
    borderSide: BorderSide(color: Color.fromARGB(216, 107, 45, 117),),
   ),

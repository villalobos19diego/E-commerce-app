...
class ProductDetailsInterior extends StatefulWidget {
  final String productId;

  const   ProductDetailsInterior ({Key? key, required this.productId}) : 
  super(key: key);
  @override
  _ProductDetailsInteriorState createState()
   => _ProductDetailsInteriorState();
}

class _ProductDetailsInteriorState extends State<ProductDetailsInterior> {

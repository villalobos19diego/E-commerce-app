...
class ProductInteriorScreen extends  StatelessWidget {
   const ProductInteriorScreen({super.key});
 
   @override
   Widget build(BuildContext context) {
   
  return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance.collection('interior').snapshots(),

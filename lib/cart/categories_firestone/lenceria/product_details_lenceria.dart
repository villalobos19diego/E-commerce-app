...
class _ProductDetailsState extends State<ProductDetails> {
  ...
  Future<void> _loadProductDetails(timer) async {
    try {
  ...
  Widget build(BuildContext context) {
    ...
    icon: Icon(
      Icons.arrow_back,
      color: Colors.purple, // Color deseado para la flecha de retroceso
    ),
    onPressed: () {
  ...
  child: Center(
    child: ElevatedButton(
      onPressed: () {
        if (selectedSize.isEmpty || selectedLocation.isEmpty) {
          // Mostrar un mensaje indicando que el usuario debe seleccionar talla y ubicación
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text(
                'Debes seleccionar talla y ubicación antes de agregar al carrito.',
      ...
      fixedSize: const Size(50, 50), // Define el ancho y alto deseados
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(10.0), // Define el radio de los bordes
      ),
    ),

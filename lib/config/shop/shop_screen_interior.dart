...
class ShopScreenInterior extends StatefulWidget{
  const ShopScreenInterior({super.key});

  @override
  State<ShopScreenInterior> createState() => _ShopScreenInteriorState();

}

 class _ShopScreenInteriorState  extends State<ShopScreenInterior>{
  @override
